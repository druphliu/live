...
class AnchorMetaTag extends \common\models\AnchorMeta
{
    public $keyName = 'tag';

    public function getTagsByAnchor($aid, $isString=false)
    {
    ...
    public function setAnchorTags($aid, $tags)
    {
        if( is_string($tags) ){
            if( empty($tags) ){
                $tags = [];
        ...
        $oldTags = $this->getTagsByAnchor($aid);
